...
function createBookInstances(cb) {
  async.parallel([
    callback => bookInstanceCreate(
      books[0], '中华书局 2014年版', false, 'KGJY', callback
    ),
    callback => bookInstanceCreate(
      books[1], '人民文学出版社 汉日对照 2017年版', false, 'YJC', callback
    ),
    callback => bookInstanceCreate(
      books[1], '人民文学出版社 汉法对照 2017年版', false, 'KGJY', callback
    ),
    callback => bookInstanceCreate(
      books[2], '海南出版社 2017年版', false, false, callback
    ),
    callback => bookInstanceCreate(
      books[2], '海南出版社 2017年版', false, 'GCWH', callback
    ),
    callback => bookInstanceCreate(
      books[2], '海南出版社 2017年版', false, 'KGJY', callback
    ),
    callback => bookInstanceCreate(
      books[3], '中国友谊出版公司 2018版', false, 'YJC', callback
    ),
    callback => bookInstanceCreate(
      books[3], '现代出版社 2018版', false, 'GCWH', callback
    ),
    callback => bookInstanceCreate(
      books[4], '浙江文艺出版社 2017版', false, 'KGJY', callback
    ),
    callback => bookInstanceCreate(
      books[4], '浙江文艺出版社 2017版', false, 'KGJY', callback
    ),
    ...
    callback => bookInstanceCreate(
      books[5], 'Harper Voyager, 2016.', false, 'KGJY', callback
    ),
    callback => bookInstanceCreate(
      books[5], 'Harper Voyager, 2016.', false, 'GCWH', callback
    ),
    callback => bookInstanceCreate(
      books[5], 'Harper Voyager, 2016.', false, 'YJC', callback
    )
  ], cb); // 可选回调
}
